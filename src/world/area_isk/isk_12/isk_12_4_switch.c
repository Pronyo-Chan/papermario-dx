...
EvtScript N(EVS_OnTouch_StaircaseSwitch) = {
    ...
    EVT_THREAD
        EVT_CALL(PlaySoundAt, SOUND_58, SOUND_SPACE_MODE_0, 449, -822, 148)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(20)
        EVT_END_IF
        EVT_CALL(PlaySoundAt, SOUND_59, SOUND_SPACE_MODE_0, 449, -822, 148)
        EVT_CALL(ShakeCam, CAM_DEFAULT, 0, 3, EVT_FLOAT(0.1))
    EVT_END_THREAD
    EVT_WAIT(50)
    EVT_THREAD
        EVT_CALL(PlaySoundAt, SOUND_58, SOUND_SPACE_MODE_0, 460, -806, 108)
        EVT_CALL(MakeLerp, -50, 0, 60, EASING_QUADRATIC_IN)
        EVT_LABEL(22)
        EVT_CALL(UpdateLerp)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(22)
        EVT_END_IF
        EVT_CALL(PlaySoundAt, SOUND_59, SOUND_SPACE_MODE_0, 460, -806, 108)
        EVT_CALL(ShakeCam, CAM_DEFAULT, 0, 3, EVT_FLOAT(0.1))
    EVT_END_THREAD
    EVT_WAIT(30)
    EVT_THREAD
        EVT_CALL(PlaySoundAt, SOUND_58, SOUND_SPACE_MODE_0, 432, -825, 189)
        EVT_CALL(MakeLerp, -50, 0, 60, EASING_QUADRATIC_IN)
        EVT_LABEL(24)
        EVT_CALL(UpdateLerp)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(24)
        EVT_END_IF
        EVT_CALL(PlaySoundAt, SOUND_59, SOUND_SPACE_MODE_0, 432, -825, 189)
        EVT_CALL(ShakeCam, CAM_DEFAULT, 0, 3, EVT_FLOAT(0.1))
    EVT_END_THREAD
    EVT_WAIT(30)
    EVT_THREAD
        EVT_CALL(PlaySoundAt, SOUND_58, SOUND_SPACE_MODE_0, 451, -812, 137)
        ...
        EVT_IF_EQ(LVar1, 1)
            EVT_GOTO(26)
        EVT_END_IF
        EVT_CALL(PlaySoundAt, SOUND_59, SOUND_SPACE_MODE_0, 451, -812, 137)
