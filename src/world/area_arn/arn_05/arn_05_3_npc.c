...
EvtScript N(EVS_Scene_TubbaRaid) = {
    ...
    EVT_LOOP(20 * DT)
        ...
        EVT_WAIT(1)
    EVT_END_LOOP
    EVT_CALL(SpeakToPlayer, NPC_Boo_03, ANIM_Boo_Tan_Flail, ANIM_Boo_Tan_Flail, 0, MSG_NPC_StanleyHide)
    ...
    EVT_WAIT(20 * DT)
    EVT_CALL(EquipBadge, ITEM_SLOW_GHOST)
    EVT_WAIT(40 * DT)
    ...
    EVT_CALL(PanToTarget, CAM_DEFAULT, 0, 1)
    EVT_CALL(WaitForCam, CAM_DEFAULT, EVT_FLOAT(1.0))
    EVT_CALL(SpeakToPlayer, NPC_Boo_03, ANIM_Boo_Tan_Flail, ANIM_Boo_Tan_Flail, 0, MSG_NPC_StanleyCool)
    EVT_WAIT(15 * DT)
    EVT_LOOP(0)
        EVT_WAIT(1)
