...
EvtScript N(EVS_NpcInteract_Bombette) = {
    ...
    EVT_IF_EQ(GF_TRD06_Met_Bombette, FALSE)
        ...
        EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_WorldBombette_Talk, ANIM_WorldBombette_Idle, 0, MSG_NPC_BombetteHelps)
        // GIVE HAMMER
    EVT_ELSE
        EVT_IF_EQ(GF_TRD06_BombedWall, TRUE)
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_WorldBombette_Talk, ANIM_WorldBombette_Idle, 0, MSG_NPC_BombetteGoodLuck)
        EVT_ELSE
            EVT_CALL(SpeakToPlayer, NPC_SELF, ANIM_WorldBombette_Talk, ANIM_WorldBombette_Idle, 0, MSG_NPC_BombetteConfidence)
        EVT_END_IF
    EVT_END_IF
