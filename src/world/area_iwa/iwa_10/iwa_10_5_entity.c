...
EvtScript N(EVS_MakeEntities) = {
    ...
    EVT_END_IF
    EVT_IF_GE(GB_StoryProgress, STORY_CH2_SPOKE_WITH_PARAKARRY)
        EVT_IF_EQ(GF_IWA10_PWing, FALSE)
            EVT_CALL(MakeItemEntity, ITEM_PWING, -500, 215, -500, ITEM_SPAWN_MODE_FALL_NEVER_VANISH, GF_IWA10_PWing)
        EVT_END_IF
    EVT_END_IF
